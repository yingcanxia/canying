		...
		<div class="hb_wrap"> -->
			...
			<div class="hb_app">
				<div class="hb_frame cl">
					<div class="hb_row cl ">
						<div class="col_2" style="width:20%;position:relative;left:-20px">
			...
			<!-- 	<div id="div-iframe" class="div-iframe" style="overflow-y: auto;width:1000px;height:600px;"> -->
							<div id="div-iframe" class="div-iframe" style="overflow-y: auto;">
							<iframe id="right-iframe" src="welcome.html" frameBorder="0" width="98%" height="100%" scrolling="auto"  style="position: absolute;right: 10px;margin-left:15px"></iframe>
				        </div>
					<!--</div>-->
				</div>
