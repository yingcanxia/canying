...
<head>
	...
	int a=(Integer)session.getAttribute("whe");%>
				...
				%>
		<form id="frm1" class="suqiu-form" style="position:absolute;top:0px;left:10%;width: 80%;" action="nstx_update.action" method="post">
				...
				<div class="templatemo-content-widget no-padding">
					<div class="panel panel-default table-responsive">
						<table class='tableBorder table  table-striped table-bordered templatemo-user-table' align=center>
							...
							<tr>
								<th class='tableHeaderText green-bg white-text' colspan=2 height=25>农事提醒</th>
								<tr>
							...
							<tr>
								...
								<td class='forumRow'>
									<div class="form-group">
										<input name='nongshi_tixing_timu' type='text' id='a_title' class="form-control" value="<%=tx.getNongshi_tixing_timu() %>">
									</div>
								</td>
							</tr>
							<tr>
								<td class="td-width" >内容</td>
								<td class='forumRow'>
									<div class="form-group">
										<!--<input name='nongshi_tixing_neirong' type='text' id='miaoshu' class="form-control">-->
											<textarea id="txt" name='nongshi_tixing_neirong' class="ckeditor"><%=tx.getNongshi_tixing_neirong() %></textarea>
									</div>
								</td>
								...
								<td height="50" colspan=2 class='forumRow'>
									<div align="center">
										<div class="form-group">
											...
											<input class="templatemo-blue-button" type="button" value="取消" onclick="javascript:window.location.href ='nstx-list.jsp';">
										</div>
									</div>
								</td>
							</tr>
		...
		<%}else{ %>
		<form id="frm1" class="suqiu-form" style="position:absolute;top:0px;left:10%;width: 80%;" action="nstx_save.action" method="post">
			<div class="templatemo-content-container" id="update" >
				<div class="templatemo-content-widget no-padding">
					<div class="panel panel-default table-responsive">
						<table class='tableBorder table  table-striped table-bordered templatemo-user-table' align=center>
							...
							<tr>
								...
								<td class='forumRow'>
									<div class="form-group">
										<input name='nongshi_tixing_timu' type='text' id='a_title' class="form-control">
									</div>
								</td>
							</tr>
							<tr>
								...
								<td class='forumRow'>
									<div class="form-group">
										<!--<input name='nongshi_tixing_neirong' type='text' id='miaoshu' class="form-control">-->
											<textarea id="txt" name='nongshi_tixing_neirong' class="ckeditor"></textarea>
									</div>
								</td>
