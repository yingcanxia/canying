...
<h1><center>单位负责人注册</center></h1>
	<script type="text/javascript">
		function zhuce() {
			var _name = $("#nameSpan").find("span").html();
			var _phone = $("#phoneSpan").find("span").html();
			
			if(validatePwd()&validateConfirmPwd()&_phone=="输入合法！"&"输入合法！"==_name){
				...
				.ajax({
					...
					success : function(result) {
						if (result == 1) {
							...
							$("#phoneSpan")
									.html(
											"<span class='text-danger'>手机号已存在！</span>");
	...
	<div class="container">
		<form class="form-horizontal" role="form" id="formA" method="post" style="margin:50px 0px 50px 300px">
			...
			<div class="form-group" id="pwdDiv">
				...
				<div class="col-sm-5" style="display:line;">
					<input type="password" class="form-control" name="passwd" id="pwd" placeholder="请输入4-10位字母和数字组成的密码" onblur="validatePwd()">
					<div id="pwdSpan"></div>
				</div>
				<span style="font-size:15px;color:red;"><p style="margin:5px 0px 0px 0px;">(必填)</p></span>
			</div>
			<div class="form-group" id="confirmpwdDiv">
				...
				<div class="col-sm-5" style="display:line;">
					<input type="password" class="form-control" name="confirmpwd" id="confirmpwd" placeholder="默认密码为123456" onblur="validateConfirmPwd()">
