...
<head>
	...
	int a=(Integer)session.getAttribute("whe");%>
				<%if(cctz!=null&&a!=-1){
					Cuncuntong_zhen zhen=cctz.getPlist().get(a-1);
				%>
		<form id="frm1" class="suqiu-form" style="position:absolute;top:0px;left:10%;width: 80%;" action="cctz_update.action" method="post">
				...
				<div class="templatemo-content-widget no-padding">
					<div class="panel panel-default table-responsive">
						<table class='tableBorder table  table-striped table-bordered templatemo-user-table' align=center>
							...
							<tr>
								<th class='tableHeaderText green-bg white-text' colspan=2 height=25>村村通-镇</th>
								<tr>
							...
							<tr>
								<td class="td-width" >城镇名称</td>
								<td class='forumRow'>
									<div class="form-group">
										<input name='zhen_mingcheng' type='text' id='a_title' class="form-control" value="<%=zhen.getZhen_mingcheng()%>">
									</div>
								</td>
							</tr>
							<tr>
								<td class="td-width" >城镇描述</td>
								<td class='forumRow'>
									<div class="form-group">
										<!--<input name='zhen_miaoshu' type='text' id='miaoshu' class="form-control">--><!--  class="form-control" -->
										<textarea id="txt" name="zhen_miaoshu" style="width: 100%;height: 100px;" class="ckeditor"  ><%=zhen.getZhen_miaoshu() %></textarea>
									</div>
								</td>
							</tr>
							<tr>
								<td height="50" colspan=2 class='forumRow'>
									<div align="center">
										<div class="form-group">
											...
											<input class="templatemo-blue-button" type="button" value="取消" onclick="javascript:window.location.href ='cctz-list.jsp';">
										</div>
									</div>
								</td>
							</tr>
...
<%}else{ %>
<form id="frm1" class="suqiu-form" style="position:absolute;top:0px;left:10%;width: 80%;" action="cctz_save.action" method="post">
			<div class="templatemo-content-container" id="update" >
				<div class="templatemo-content-widget no-padding">
					<div class="panel panel-default table-responsive">
						<table class='tableBorder table  table-striped table-bordered templatemo-user-table' align=center>
							...
							<tr>
								...
								<td class='forumRow'>
									<div class="form-group">
										<input name='zhen_mingcheng' type='text' id='a_title' class="form-control">
									</div>
								</td>
							</tr>
							<tr>
								...
								<td class='forumRow'>
									<div class="form-group">
										<!--<input name='zhen_miaoshu' type='text' id='miaoshu' class="form-control">--><!-- class="form-control" -->
										<textarea id="txt" name="zhen_miaoshu" style="width: 100%;height: 100px;" class="ckeditor"  ></textarea>
									</div>
								</td>
							</tr>
							<tr>
