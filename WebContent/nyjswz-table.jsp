...
<head>
	...
	<body>
	<%PageList<Nongyejishu> b=(PageList)session.getAttribute("nyjs");
	int a=(Integer)session.getAttribute("whe");%>
				<%if(b!=null&&a!=-1){
				
				Nongyejishu js=b.getPlist().get(a-1);
				%>
		<form id="frm1" class="suqiu-form" style="position:absolute;top:0px;left:10%;width: 80%;" action="nyjs_update2.action" method="post">
				...
				<div class="templatemo-content-widget no-padding">
					<div class="panel panel-default table-responsive">
						<table class='tableBorder table  table-striped table-bordered templatemo-user-table' align=center>
							...
							<tr>
								<td class="td-width" >文章题目</td>
								<td class='forumRow'>
									<div class="form-group">
										<input name='wenzhang_timu' type='text' id='a_title' class="form-control" value="<%=js.getWenzhang_timu()%>">
									</div>
								</td>
							</tr>
							<tr>
								<td class="td-width" >文章内容</td>
								<td class='forumRow'>
									<div class="form-group">
										<!--<input name='fabu_nongmin_suqiu_timu' type='text' id='miaoshu' class="form-control">-->
											<textarea id="txt" name="wenzhang_neirong" class="ckeditor"><%=js.getWenzhang_neirong() %></textarea>
									</div>
								</td>
		...
		<%}else{ %>
		<form id="frm1" class="suqiu-form" style="position:absolute;top:0px;left:10%;width: 80%;" action="nyjs_save2.action" method="post">
			<div class="templatemo-content-container" id="update" >
				<div class="templatemo-content-widget no-padding">
					<div class="panel panel-default table-responsive">
						<table class='tableBorder table  table-striped table-bordered templatemo-user-table' align=center>
							...
							<tr>
								...
								<td class='forumRow'>
									<div class="form-group">
										<input name='wenzhang_timu' type='text' id='a_title' class="form-control">
									</div>
								</td>
							</tr>
							<tr>
								<td class="td-width" >文章描述</td>
								<td class='forumRow'>
									<div class="form-group">
										<!--<input name='fabu_nongmin_suqiu_timu' type='text' id='miaoshu' class="form-control">-->
											<textarea id="txt" name="wenzhang_neirong" class="ckeditor"></textarea>
									</div>
								</td>
