...
<head>
	...
	if(smwd.size()>0&&a!=-1){
		Shuoming_wendang si=smwd.get(a-1);
		int suoshuzhen = si.getType();
	%>
		<form id="frm1" class="suqiu-form" style="position:absolute;top:0px;left:10%;width: 80%;" action="smwd_update.action" method="post">
				...
				<div class="templatemo-content-widget no-padding">
					<div class="panel panel-default table-responsive">
						<table class='tableBorder table  table-striped table-bordered templatemo-user-table' align=center>
							...
							<tr>
								<th class='tableHeaderText green-bg white-text' colspan=2 height=25>说明文档</th>
								<tr>
							...
							<tr>
								<td class="td-width" >说明文档类型</td>
								<td class='forumRow'>
									<div class="form-group">
										<select  class="form-control" name="shuoming_type">
										<%if(suoshuzhen==0){%>
											<option value="0" selected="selected">农资采购</option>
											<option value="1">医疗平台</option>
										<%}else{ %>
											<option value="0">农资采购</option>
											<option value="1" selected="selected">医疗平台</option>
										<%} %>
										</select>
									</div>
								</td>
							...
							<tr>
								<td class="td-width" >说明文档内容</td>
								<td class='fabu_nongmin_suqiu_neirong'>
									<div class="form-group">
										<!--<input name='shipin_dizhi' type='text' id='cid' class="form-control">-->
											<textarea id="txt" name="shuoming_neirong" class="ckeditor"><%=si.getNeirong() %></textarea>
									</div>
								</td>
							</tr>
								...
								<td height="50" colspan=2 class='forumRow'>
									<div align="center">
										<div class="form-group">
											...
											<input class="templatemo-blue-button" type="button" value="取消" onclick="javascript:window.location.href ='smwd-list.jsp';">
										</div>
									</div>
								</td>
							</tr>
...
<%}else{ %>
<form id="frm1" class="suqiu-form" style="position:absolute;top:0px;left:10%;width: 80%;" action="smwd_save.action" method="post">
			<div class="templatemo-content-container" id="update" >
				<div class="templatemo-content-widget no-padding">
					<div class="panel panel-default table-responsive">
						<table class='tableBorder table  table-striped table-bordered templatemo-user-table' align=center>
							...
							<tr>
								...
								<td class='fabu_nongmin_suqiu_neirong'>
									<div class="form-group">
										<!--<input name='shipin_dizhi' type='text' id='cid' class="form-control">-->
											<textarea id="txt" name="shuoming_neirong" class="ckeditor"></textarea>
									</div>
								</td>
							</tr>
